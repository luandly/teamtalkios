...
GPBEnumDescriptor *BuddyListCmdID_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "stSignInfoChangedNotify\000CidBuddyListUser"
        "InfoChangedNotify\000CidBuddyListDepartment"
        "InfoChangedNotify\000";
    static const int32_t values[] = {
        ...
        BuddyListCmdID_CidBuddyListUserInfoChangedNotify,
        BuddyListCmdID_CidBuddyListDepartmentInfoChangedNotify,
    };
    GPBEnumDescriptor *worker =
...
BOOL BuddyListCmdID_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case BuddyListCmdID_CidBuddyListUserInfoChangedNotify:
    case BuddyListCmdID_CidBuddyListDepartmentInfoChangedNotify:
      return YES;
    default:
      return NO;
  }
...
GPBEnumDescriptor *MsgType_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "TypeOfflineFile\000MsgTypeSingleLocation\000Ms"
        "gTypeGroupText\000MsgTypeGroupAudio\000MsgType"
        "GroupFile\000MsgTypeGroupLocation\000";
    static const int32_t values[] = {
        MsgType_MsgTypeSingleText,
        MsgType_MsgTypeSingleAudio,
        MsgType_MsgTypeOfflineFile,
        MsgType_MsgTypeSingleLocation,
        MsgType_MsgTypeGroupText,
        MsgType_MsgTypeGroupAudio,
        MsgType_MsgTypeGroupFile,
        MsgType_MsgTypeGroupLocation,
    };
    GPBEnumDescriptor *worker =
...
BOOL MsgType_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case MsgType_MsgTypeOfflineFile:
    case MsgType_MsgTypeSingleLocation:
    case MsgType_MsgTypeGroupText:
    case MsgType_MsgTypeGroupAudio:
    case MsgType_MsgTypeGroupFile:
    case MsgType_MsgTypeGroupLocation:
      return YES;
    default:
      return NO;
  }
...
GPBEnumDescriptor *GroupModifyType_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "GroupModifyTypeAdd\000GroupModifyTypeDel\000Gr"
        "oupModifyTypeExit\000GroupModifyTypeDismiss"
        "\000";
    static const int32_t values[] = {
        GroupModifyType_GroupModifyTypeAdd,
        GroupModifyType_GroupModifyTypeDel,
        GroupModifyType_GroupModifyTypeExit,
        GroupModifyType_GroupModifyTypeDismiss,
    };
    GPBEnumDescriptor *worker =
