...
typedef GPB_ENUM(BuddyListCmdID) {
  ...
  /** 后台调整个人资料 */
  BuddyListCmdID_CidBuddyListUserInfoChangedNotify = 534,

  /** 后台调整组织资料 */
  BuddyListCmdID_CidBuddyListDepartmentInfoChangedNotify = 535,
};
...
typedef GPB_ENUM(MsgType) {
  ...
  /** 文件消息类型，离线传输文件模式时，向对方发送的消息 */
  MsgType_MsgTypeOfflineFile = 3,

  /** 我的位置 */
  MsgType_MsgTypeSingleLocation = 4,
  MsgType_MsgTypeGroupText = 17,
  MsgType_MsgTypeGroupAudio = 18,

  /** 群文件消息类型 */
  MsgType_MsgTypeGroupFile = 19,

  /** 群组我的位置 */
  MsgType_MsgTypeGroupLocation = 20,
};
...
typedef GPB_ENUM(GroupModifyType) {
  ...
  /** 退出组 */
  GroupModifyType_GroupModifyTypeExit = 3,

  /** 解散组 */
  GroupModifyType_GroupModifyTypeDismiss = 4,
};
