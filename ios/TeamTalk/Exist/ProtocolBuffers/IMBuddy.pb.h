...
typedef GPB_ENUM(IMUserInfoChangedNotify_FieldNumber) {
  IMUserInfoChangedNotify_FieldNumber_ChangedUserId = 1,
};

/**
 * 后台用户资料修改通知（广播）
 **/
@interface IMUserInfoChangedNotify : GPBMessage
...
typedef GPB_ENUM(IMDepartmentInfoChangedNotify_FieldNumber) {
  IMDepartmentInfoChangedNotify_FieldNumber_ChangedDepartmentId = 1,
};

/**
 * 后台组织资料修改通知（广播）
 **/
@interface IMDepartmentInfoChangedNotify : GPBMessage

/** cmd id:		0x0217 */
@property(nonatomic, readwrite) uint32_t changedDepartmentId;

@property(nonatomic, readwrite) BOOL hasChangedDepartmentId;
@end
