...
#pragma mark - IMUserInfoChangedNotify

@implementation IMUserInfoChangedNotify

@dynamic hasChangedUserId, changedUserId;

typedef struct IMUserInfoChangedNotify__storage_ {
  uint32_t _has_storage_[1];
  uint32_t changedUserId;
} IMUserInfoChangedNotify__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "changedUserId",
        .dataTypeSpecific.className = NULL,
        .number = IMUserInfoChangedNotify_FieldNumber_ChangedUserId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(IMUserInfoChangedNotify__storage_, changedUserId),
        .flags = GPBFieldRequired,
        .dataType = GPBDataTypeUInt32,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[IMUserInfoChangedNotify class]
                                     rootClass:[ImBuddyRoot class]
                                          file:ImBuddyRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(IMUserInfoChangedNotify__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
...
#pragma mark - IMDepartmentInfoChangedNotify

@implementation IMDepartmentInfoChangedNotify

@dynamic hasChangedDepartmentId, changedDepartmentId;

typedef struct IMDepartmentInfoChangedNotify__storage_ {
  uint32_t _has_storage_[1];
  uint32_t changedDepartmentId;
} IMDepartmentInfoChangedNotify__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "changedDepartmentId",
        .dataTypeSpecific.className = NULL,
        .number = IMDepartmentInfoChangedNotify_FieldNumber_ChangedDepartmentId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(IMDepartmentInfoChangedNotify__storage_, changedDepartmentId),
        .flags = GPBFieldRequired,
        .dataType = GPBDataTypeUInt32,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[IMDepartmentInfoChangedNotify class]
                                     rootClass:[ImBuddyRoot class]
                                          file:ImBuddyRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(IMDepartmentInfoChangedNotify__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
