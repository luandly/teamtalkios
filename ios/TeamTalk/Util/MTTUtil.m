...
+(NSString*)getServer{
    NSString *addr = [[NSUserDefaults standardUserDefaults] objectForKey:@"SERVER_ADDR"];
    if(!addr){
        addr = SERVER_ADDR;
    }
...
+(void)saveServer:(NSString *)url{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:url forKey:@"SERVER_ADDR"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
