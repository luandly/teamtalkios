...
enum{
    ...
    IM_DEPARTMENT_REQ                           = 0x0210,
    IM_DEPARTMENT_RES                           = 0x0211,
    CID_BUDDY_LIST_USER_INFO_CHANGED_NOTIFY     = 0x0216,
    CID_BUDDY_LIST_DEPARTMENT_INFO_CHANGED_NOTIFY     = 0x0217,
};
...
enum
{
    ...
    IM_GROU_CHANGE_MEMBER_NOTIFY                = 0x040b,
};
