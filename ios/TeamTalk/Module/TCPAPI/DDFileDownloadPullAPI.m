//
//  DDFileDownloadPullAPI.m
//  TeamTalk
//
//  Created by li xiaoxiao on 2018/9/2.
...
@implementation DDFileDownloadPullAPI
/**
 *  请求超时时间
 *
 *  @return 超时时间
...
{
    return FileCmdID_CidFilePullDataRsp;
}
...
- (Analysis)analysisReturnData
{
    ...
    {
        IMFilePullDataRsp *pull = [IMFilePullDataRsp parseFromData:data error:nil];
        return pull;
    };
    return analysis;
}
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t seqNo)
    {
        ...
        IMFilePullDataReq *file = [IMFilePullDataReq new];
        file.userId = fileentity.fromUserId.intValue;
        file.taskId = fileentity.task_id;
        file.offset = fileentity.offset;
        file.dataSize = (int)fileentity.dataSize;
        file.transMode = TransferFileType_FileTypeOffline;
