...
- (Analysis)analysisReturnData
{
    ...
    NSMutableArray *array = [NSMutableArray new];
        ...
        NSUInteger userCnt = rsp.curUserIdListArray_Count;
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint16_t seqNo)
    {
        ...
        memberChange.userId = 0;
        memberChange.changeType = GroupModifyType_GroupModifyTypeAdd;
        memberChange.groupId = [MTTUtil changeIDToOriginal:groupId];
        [memberChange.memberIdListArray removeAll];
        for(NSNumber * num in users){
            [memberChange.memberIdListArray addValue:num.intValue];
        }
