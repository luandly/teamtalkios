...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint16_t seqNo)
    {
        ...
        IMChangeSignInfoReq *changeSign = [[IMChangeSignInfoReq alloc] init];
        changeSign.userId = [MTTUserEntity localIDTopb:TheRuntime.user.objID];
        changeSign.signInfo = signInfo;
        ...
        [dataout writeTcpProtocolHeader:SID_BUDDY_LIST
                                  ...
                                  seqNo:seqNo];
        [dataout directWriteBytes:[changeSign data]];
