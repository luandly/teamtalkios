...
- (void)viewDidLoad
{
    ...
    UIButton *change = [[UIButton alloc] initWithFrame:CGRectMake(0, 400 * DL_SCREEN_SCALE, DL_SCREEN_WIDTH, 40 * DL_SCREEN_SCALE)];
    [change setTitle:@"切换登录服务器" forState:UIControlStateNormal];
    [change setTitleColor:RGB(214, 214, 214) forState:UIControlStateNormal];
...
#pragma mark - private
-(void)changeClick{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"输入登录服务器地址" message:@"" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定",nil];
    alert.alertViewStyle=UIAlertViewStylePlainTextInput;
    UITextField *tf=[alert textFieldAtIndex:0];
    [tf setText:[MTTUtil getServer]];
    [alert show];
}
